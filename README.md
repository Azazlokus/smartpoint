...
| Диаграмма | Описание |
|---|---|
| [ER-диаграмма](docs/er-diagram.md) | Схема базы данных и связи между таблицами |
| [Поток мониторинга](docs/monitoring-flow.md) | Sequence-диаграммы: штатный цикл, путь ошибки, ручное восстановление |
| [Диаграмма классов](docs/class-diagram.md) | Адаптеры, Jobs, HTTP-слой |
